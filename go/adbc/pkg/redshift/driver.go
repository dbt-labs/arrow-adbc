...
//
// int RedshiftArrayStreamGetSchema(struct ArrowArrayStream*, struct ArrowSchema*);
// int RedshiftArrayStreamGetNext(struct ArrowArrayStream*, struct ArrowArray*);
// const char* RedshiftArrayStreamGetLastError(struct ArrowArrayStream*);
// void RedshiftArrayStreamRelease(struct ArrowArrayStream*);
//
// int RedshiftArrayStreamGetSchemaTrampoline(struct ArrowArrayStream*, struct ArrowSchema*);
// int RedshiftArrayStreamGetNextTrampoline(struct ArrowArrayStream*, struct ArrowArray*);
//
...
var drv = .NewDriver(mallocator.NewMallocator())
...
const errPrefix = "[Redshift] "
const logLevelEnvVar = "ADBC_DRIVER_REDSHIFT_LOG_LEVEL"
...
func setErr(err *C.struct_AdbcError, format string, vals ...interface{}) {
	...
	if err.release != nil {
		C.RedshifterrRelease(err)
	}

	msg := errPrefix + fmt.Sprintf(format, vals...)
	err.message = C.CString(msg)
	err.release = (*[0]byte)(C.Redshift_release_error)
}
...
func setErrWithDetails(err *C.struct_AdbcError, adbcError adbc.Error) {
	...
	cErrPtr := C.calloc(C.sizeof_struct_RedshiftError, C.size_t(1))
	cErr := (*C.struct_RedshiftError)(cErrPtr)
	cErr.message = C.CString(adbcError.Msg)
	err.message = cErr.message
	err.release = (*[0]byte)(C.RedshiftReleaseErrWithDetails)
...
func poison(err *C.struct_AdbcError, fname string, e interface{}) C.AdbcStatusCode {
	if !globalPoison.Swap(true) {
		...
		fmt.Fprintf(os.Stderr, "Redshift driver panicked, stack traces:\n%s", buf[:length])
	}
	setErr(err, "%s: Go panic in Redshift driver (see stderr): %#v", fname, e)
...
func initLoggingFromEnv(db adbc.Database) {
	...
	if !ok {
		logger.Error("Redshift does not support logging")
		return
	}
...
func printLoggingHelp() {
	fmt.Fprintf(os.Stderr, "Redshift: to enable logging, set %s to 'debug', 'info', 'warn', or 'error'", logLevelEnvVar)
}
...
func (cStream *cArrayStream) maybeError() C.int {
	...
	if err != nil {
		if cStream.adbcErr != nil {
			C.RedshifterrRelease(cStream.adbcErr)
		} else {
...
//export RedshiftArrayStreamGetLastError
func RedshiftArrayStreamGetLastError(stream *C.struct_ArrowArrayStream) *C.cchar_t {
	if stream == nil || stream.release != (*[0]byte)(C.RedshiftArrayStreamRelease) || stream.private_data == nil {
		return nil
	}
...
//export RedshiftArrayStreamGetNext
func RedshiftArrayStreamGetNext(stream *C.struct_ArrowArrayStream, array *C.struct_ArrowArray) C.int {
	if stream == nil || stream.release != (*[0]byte)(C.RedshiftArrayStreamRelease) || stream.private_data == nil  {
		return C.EINVAL
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
//export RedshiftArrayStreamGetSchema
func RedshiftArrayStreamGetSchema(stream *C.struct_ArrowArrayStream, schema *C.struct_ArrowSchema) C.int {
	if stream == nil || stream.release != (*[0]byte)(C.RedshiftArrayStreamRelease) || stream.private_data == nil  {
		return C.EINVAL
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
//export RedshiftArrayStreamRelease
func RedshiftArrayStreamRelease(stream *C.struct_ArrowArrayStream) {
	if stream == nil || stream.release != (*[0]byte)(C.RedshiftArrayStreamRelease) || stream.private_data == nil  {
		return
	}
...
//export RedshiftErrorFromArrayStream
func RedshiftErrorFromArrayStream(stream *C.struct_ArrowArrayStream, status *C.AdbcStatusCode) (*C.struct_AdbcError) {
	if stream == nil || stream.release != (*[0]byte)(C.RedshiftArrayStreamRelease) || stream.private_data == nil  {
		return nil
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
func exportRecordReader(rdr array.RecordReader, stream *C.struct_ArrowArrayStream) {
	...
	stream.get_last_error = (*[0]byte)(C.RedshiftArrayStreamGetLastError)
	stream.get_next = (*[0]byte)(C.RedshiftArrayStreamGetNextTrampoline)
	stream.get_schema = (*[0]byte)(C.RedshiftArrayStreamGetSchemaTrampoline)
	stream.release = (*[0]byte)(C.RedshiftArrayStreamRelease)
...
//export RedshiftDatabaseGetOption
func RedshiftDatabaseGetOption(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftDatabaseGetOptionBytes
func RedshiftDatabaseGetOptionBytes(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftDatabaseGetOptionDouble
func RedshiftDatabaseGetOptionDouble(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftDatabaseGetOptionInt
func RedshiftDatabaseGetOptionInt(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftDatabaseInit
func RedshiftDatabaseInit(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftDatabaseNew
func RedshiftDatabaseNew(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftDatabaseRelease
func RedshiftDatabaseRelease(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcDatabaseInit", e)
		}
...
//export RedshiftDatabaseSetOption
func RedshiftDatabaseSetOption(db *C.struct_AdbcDatabase, key, value *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftDatabaseSetOptionBytes
func RedshiftDatabaseSetOptionBytes(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftDatabaseSetOptionDouble
func RedshiftDatabaseSetOptionDouble(db *C.struct_AdbcDatabase, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftDatabaseSetOptionInt
func RedshiftDatabaseSetOptionInt(db *C.struct_AdbcDatabase, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftConnectionGetOption
func RedshiftConnectionGetOption(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftConnectionGetOptionBytes
func RedshiftConnectionGetOptionBytes(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftConnectionGetOptionDouble
func RedshiftConnectionGetOptionDouble(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftConnectionGetOptionInt
func RedshiftConnectionGetOptionInt(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftConnectionNew
func RedshiftConnectionNew(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftConnectionSetOption
func RedshiftConnectionSetOption(cnxn *C.struct_AdbcConnection, key, val *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftConnectionSetOptionBytes
func RedshiftConnectionSetOptionBytes(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftConnectionSetOptionDouble
func RedshiftConnectionSetOptionDouble(db *C.struct_AdbcConnection, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftConnectionSetOptionInt
func RedshiftConnectionSetOptionInt(db *C.struct_AdbcConnection, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftConnectionInit
func RedshiftConnectionInit(cnxn *C.struct_AdbcConnection, db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftConnectionRelease
func RedshiftConnectionRelease(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftConnectionCancel
func RedshiftConnectionCancel(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftConnectionGetInfo
func RedshiftConnectionGetInfo(cnxn *C.struct_AdbcConnection, codes *C.cuint32_t, len C.size_t, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftConnectionGetObjects
func RedshiftConnectionGetObjects(cnxn *C.struct_AdbcConnection, depth C.int, catalog, dbSchema, tableName *C.cchar_t, tableType **C.cchar_t, columnName *C.cchar_t,
...
//export RedshiftConnectionGetStatistics
func RedshiftConnectionGetStatistics(cnxn *C.struct_AdbcConnection, catalog, dbSchema, tableName *C.cchar_t, approximate C.char, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftConnectionGetStatisticNames
func RedshiftConnectionGetStatisticNames(cnxn *C.struct_AdbcConnection, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcConnectionGetStatistics", e)
		}
...
//export RedshiftConnectionGetTableSchema
func RedshiftConnectionGetTableSchema(cnxn *C.struct_AdbcConnection, catalog, dbSchema, tableName *C.cchar_t, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftConnectionGetTableTypes
func RedshiftConnectionGetTableTypes(cnxn *C.struct_AdbcConnection, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftConnectionReadPartition
func RedshiftConnectionReadPartition(cnxn *C.struct_AdbcConnection, serialized *C.cuint8_t, serializedLen C.size_t, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftConnectionCommit
func RedshiftConnectionCommit(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftConnectionRollback
func RedshiftConnectionRollback(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftStatementGetOption
func RedshiftStatementGetOption(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftStatementGetOptionBytes
func RedshiftStatementGetOptionBytes(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftStatementGetOptionDouble
func RedshiftStatementGetOptionDouble(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftStatementGetOptionInt
func RedshiftStatementGetOptionInt(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftStatementNew
func RedshiftStatementNew(cnxn *C.struct_AdbcConnection, stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftStatementRelease
func RedshiftStatementRelease(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftStatementCancel
func RedshiftStatementCancel(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftStatementPrepare
func RedshiftStatementPrepare(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftStatementExecuteQuery
func RedshiftStatementExecuteQuery(stmt *C.struct_AdbcStatement, out *C.struct_ArrowArrayStream, affected *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftStatementExecuteSchema
func RedshiftStatementExecuteSchema(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcStatementExecuteQuery", e)
		}
...
//export RedshiftStatementSetSqlQuery
func RedshiftStatementSetSqlQuery(stmt *C.struct_AdbcStatement, query *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftStatementSetSubstraitPlan
func RedshiftStatementSetSubstraitPlan(stmt *C.struct_AdbcStatement, plan *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftStatementBind
func RedshiftStatementBind(stmt *C.struct_AdbcStatement, values *C.struct_ArrowArray, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftStatementBindStream
func RedshiftStatementBindStream(stmt *C.struct_AdbcStatement, stream *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftStatementGetParameterSchema
func RedshiftStatementGetParameterSchema(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftStatementSetOption
func RedshiftStatementSetOption(stmt *C.struct_AdbcStatement, key, value *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftStatementSetOptionBytes
func RedshiftStatementSetOptionBytes(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftStatementSetOptionDouble
func RedshiftStatementSetOptionDouble(db *C.struct_AdbcStatement, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftStatementSetOptionInt
func RedshiftStatementSetOptionInt(db *C.struct_AdbcStatement, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftStatementExecutePartitions
func RedshiftStatementExecutePartitions(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, partitions *C.struct_AdbcPartitions, affected *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export RedshiftDriverInit
func RedshiftDriverInit(version C.int, rawDriver *C.void, err *C.struct_AdbcError) C.AdbcStatusCode {
	...
	driver.DatabaseInit = (*[0]byte)(C.RedshiftDatabaseInit)
	driver.DatabaseNew = (*[0]byte)(C.RedshiftDatabaseNew)
	driver.DatabaseRelease = (*[0]byte)(C.RedshiftDatabaseRelease)
	driver.DatabaseSetOption = (*[0]byte)(C.RedshiftDatabaseSetOption)

	driver.ConnectionNew = (*[0]byte)(C.RedshiftConnectionNew)
	driver.ConnectionInit = (*[0]byte)(C.RedshiftConnectionInit)
	driver.ConnectionRelease = (*[0]byte)(C.RedshiftConnectionRelease)
	driver.ConnectionSetOption = (*[0]byte)(C.RedshiftConnectionSetOption)
	driver.ConnectionGetInfo = (*[0]byte)(C.RedshiftConnectionGetInfo)
	driver.ConnectionGetObjects = (*[0]byte)(C.RedshiftConnectionGetObjects)
	driver.ConnectionGetTableSchema = (*[0]byte)(C.RedshiftConnectionGetTableSchema)
	driver.ConnectionGetTableTypes = (*[0]byte)(C.RedshiftConnectionGetTableTypes)
	driver.ConnectionReadPartition = (*[0]byte)(C.RedshiftConnectionReadPartition)
	driver.ConnectionCommit = (*[0]byte)(C.RedshiftConnectionCommit)
	driver.ConnectionRollback = (*[0]byte)(C.RedshiftConnectionRollback)

	driver.StatementNew = (*[0]byte)(C.RedshiftStatementNew)
	driver.StatementRelease = (*[0]byte)(C.RedshiftStatementRelease)
	driver.StatementSetOption = (*[0]byte)(C.RedshiftStatementSetOption)
	driver.StatementSetSqlQuery = (*[0]byte)(C.RedshiftStatementSetSqlQuery)
	driver.StatementSetSubstraitPlan = (*[0]byte)(C.RedshiftStatementSetSubstraitPlan)
	driver.StatementBind = (*[0]byte)(C.RedshiftStatementBind)
	driver.StatementBindStream = (*[0]byte)(C.RedshiftStatementBindStream)
	driver.StatementExecuteQuery = (*[0]byte)(C.RedshiftStatementExecuteQuery)
	driver.StatementExecutePartitions = (*[0]byte)(C.RedshiftStatementExecutePartitions)
	driver.StatementGetParameterSchema = (*[0]byte)(C.RedshiftStatementGetParameterSchema)
	driver.StatementPrepare = (*[0]byte)(C.RedshiftStatementPrepare)

	if version == C.ADBC_VERSION_1_1_0 {
		driver.ErrorGetDetailCount = (*[0]byte)(C.RedshiftErrorGetDetailCount)
		driver.ErrorGetDetail = (*[0]byte)(C.RedshiftErrorGetDetail)
		driver.ErrorFromArrayStream = (*[0]byte)(C.RedshiftErrorFromArrayStream)

		driver.DatabaseGetOption = (*[0]byte)(C.RedshiftDatabaseGetOption)
		driver.DatabaseGetOptionBytes = (*[0]byte)(C.RedshiftDatabaseGetOptionBytes)
		driver.DatabaseGetOptionDouble = (*[0]byte)(C.RedshiftDatabaseGetOptionDouble)
		driver.DatabaseGetOptionInt = (*[0]byte)(C.RedshiftDatabaseGetOptionInt)
		driver.DatabaseSetOptionBytes = (*[0]byte)(C.RedshiftDatabaseSetOptionBytes)
		driver.DatabaseSetOptionDouble = (*[0]byte)(C.RedshiftDatabaseSetOptionDouble)
		driver.DatabaseSetOptionInt = (*[0]byte)(C.RedshiftDatabaseSetOptionInt)

		driver.ConnectionCancel = (*[0]byte)(C.RedshiftConnectionCancel)
		driver.ConnectionGetOption = (*[0]byte)(C.RedshiftConnectionGetOption)
		driver.ConnectionGetOptionBytes = (*[0]byte)(C.RedshiftConnectionGetOptionBytes)
		driver.ConnectionGetOptionDouble = (*[0]byte)(C.RedshiftConnectionGetOptionDouble)
		driver.ConnectionGetOptionInt = (*[0]byte)(C.RedshiftConnectionGetOptionInt)
		driver.ConnectionGetStatistics = (*[0]byte)(C.RedshiftConnectionGetStatistics)
		driver.ConnectionGetStatisticNames = (*[0]byte)(C.RedshiftConnectionGetStatisticNames)
		driver.ConnectionSetOptionBytes = (*[0]byte)(C.RedshiftConnectionSetOptionBytes)
		driver.ConnectionSetOptionDouble = (*[0]byte)(C.RedshiftConnectionSetOptionDouble)
		driver.ConnectionSetOptionInt = (*[0]byte)(C.RedshiftConnectionSetOptionInt)

		driver.StatementCancel = (*[0]byte)(C.RedshiftStatementCancel)
		driver.StatementExecuteSchema = (*[0]byte)(C.RedshiftStatementExecuteSchema)
		driver.StatementGetOption = (*[0]byte)(C.RedshiftStatementGetOption)
		driver.StatementGetOptionBytes = (*[0]byte)(C.RedshiftStatementGetOptionBytes)
		driver.StatementGetOptionDouble = (*[0]byte)(C.RedshiftStatementGetOptionDouble)
		driver.StatementGetOptionInt = (*[0]byte)(C.RedshiftStatementGetOptionInt)
		driver.StatementSetOptionBytes = (*[0]byte)(C.RedshiftStatementSetOptionBytes)
		driver.StatementSetOptionDouble = (*[0]byte)(C.RedshiftStatementSetOptionDouble)
		driver.StatementSetOptionInt = (*[0]byte)(C.RedshiftStatementSetOptionInt)
	}
